         ...
         <div className="content">
            ...
            <div className="sub-content">
                <p>
                    ...
                    from the first muddle to the final garnish. That cares is what turns a simple
                    drink into something truly memorable.
                </p>
                 <div>
             <p className="md:text-3xl text font-bold">
                <span>4.5</span>/5
            </p>
       ...
       <div className="top-grid">
        <div className="md:col-span-3">
          ...
          <div className="md:col-span-6">
            <div className="noisy flex justify-center items-center">
             <h1 className="lg:text-9xl text-4xl font-black font-modern-negra text-center">Cocktails</h1>
            </div>
        </div>
